  ...
  (() => {
          ...
          let f = (t.ThemeService = class extends a.Disposable {
            ...
            constructor(e) {
              super(),
                ...
                (this._contrastCache = new i.ColorContrastCache()),
                (this._halfContrastCache = new i.ColorContrastCache()),
            ...
            _setTheme(e = {}) {
              ...
              if (
                ((s.foreground = g(e.foreground, h)),
                (s.background = g(e.background, u)),
                (s.cursor = g(e.cursor, _)),
                (s.cursorAccent = g(e.cursorAccent, d)),
                (s.selectionBackgroundTransparent = g(
                  e.selectionBackground,
                  C
                )),
                (s.selectionBackgroundOpaque = n.color.blend(
                  s.background,
                  s.selectionBackgroundTransparent
                )),
                (s.selectionInactiveBackgroundTransparent = g(
                  e.selectionInactiveBackground,
                  s.selectionBackgroundTransparent
                )),
                (s.selectionInactiveBackgroundOpaque = n.color.blend(
                  s.background,
                  s.selectionInactiveBackgroundTransparent
                )),
                (s.selectionForeground = e.selectionForeground
                  ? g(e.selectionForeground, n.NULL_COLOR)
                  : void 0),
                s.selectionForeground === n.NULL_COLOR &&
                  (s.selectionForeground = void 0),
                n.color.isOpaque(s.selectionBackgroundTransparent))
              ) {
                const e = 0.3
                s.selectionBackgroundTransparent = n.color.opacity(
                  s.selectionBackgroundTransparent,
                  e
                )
              }
              if (n.color.isOpaque(s.selectionInactiveBackgroundTransparent)) {
                const e = 0.3
                s.selectionInactiveBackgroundTransparent = n.color.opacity(
                  s.selectionInactiveBackgroundTransparent,
                  e
                )
              }
              if (
                ((s.ansi = t.DEFAULT_ANSI_COLORS.slice()),
                (s.ansi[0] = g(e.black, t.DEFAULT_ANSI_COLORS[0])),
                (s.ansi[1] = g(e.red, t.DEFAULT_ANSI_COLORS[1])),
                (s.ansi[2] = g(e.green, t.DEFAULT_ANSI_COLORS[2])),
                (s.ansi[3] = g(e.yellow, t.DEFAULT_ANSI_COLORS[3])),
                (s.ansi[4] = g(e.blue, t.DEFAULT_ANSI_COLORS[4])),
                (s.ansi[5] = g(e.magenta, t.DEFAULT_ANSI_COLORS[5])),
                (s.ansi[6] = g(e.cyan, t.DEFAULT_ANSI_COLORS[6])),
                (s.ansi[7] = g(e.white, t.DEFAULT_ANSI_COLORS[7])),
                (s.ansi[8] = g(e.brightBlack, t.DEFAULT_ANSI_COLORS[8])),
                (s.ansi[9] = g(e.brightRed, t.DEFAULT_ANSI_COLORS[9])),
                (s.ansi[10] = g(e.brightGreen, t.DEFAULT_ANSI_COLORS[10])),
                (s.ansi[11] = g(e.brightYellow, t.DEFAULT_ANSI_COLORS[11])),
                (s.ansi[12] = g(e.brightBlue, t.DEFAULT_ANSI_COLORS[12])),
                (s.ansi[13] = g(e.brightMagenta, t.DEFAULT_ANSI_COLORS[13])),
                (s.ansi[14] = g(e.brightCyan, t.DEFAULT_ANSI_COLORS[14])),
                (s.ansi[15] = g(e.brightWhite, t.DEFAULT_ANSI_COLORS[15])),
                e.extendedAnsi)
              ) {
          ...
          ;(t.NULL_COLOR = { css: '#00000000', rgba: 0 }),
            ...
            (function (e) {
              function t(e, t) {
                return (
                  (i = Math.round(255 * t)),
                  ([s, r, o] = h.toChannels(e.rgba)),
                  { css: n.toCss(s, r, o, i), rgba: n.toRgba(s, r, o, i) }
                )
              }
              ;(e.blend = function (e, t) {
                if (((i = (255 & t.rgba) / 255), 1 === i))
                ...
                const l = (t.rgba >> 24) & 255,
                  ...
                  _ = (e.rgba >> 8) & 255
                return (
                  (s = h + Math.round((l - h) * i)),
                  (r = u + Math.round((a - u) * i)),
                  (o = _ + Math.round((c - _) * i)),
                  { css: n.toCss(s, r, o), rgba: n.toRgba(s, r, o) }
                )
              }),
                ...
                (e.opaque = function (e) {
                  ...
                  return (
                    ([s, r, o] = h.toChannels(t)),
                    { css: n.toCss(s, r, o), rgba: t }
                  )
                }),
                (e.opacity = t),
                (e.multiplyOpacity = function (e, s) {
            ...
            (function (e) {
              ...
              try {
                ...
                s &&
                  ...
                  (l = t.createLinearGradient(0, 0, 1, 1)))
              } catch {}
              e.toColor = function (e) {
                if (e.match(/#[\da-f]{3,8}/i))
                  switch (e.length) {
                    case 4:
                      return (
                        (s = parseInt(e.slice(1, 2).repeat(2), 16)),
                    ...
                    case 5:
                      return (
                        ...
                        (r = parseInt(e.slice(2, 3).repeat(2), 16)),
                        (o = parseInt(e.slice(3, 4).repeat(2), 16)),
                        (i = parseInt(e.slice(4, 5).repeat(2), 16)),
                        n.toColor(s, r, o, i)
                      )
                    case 7:
                      return {
                ...
                if (a)
                  return (
                    ...
                    (o = parseInt(a[3])),
                    (i = Math.round(
                      255 * (void 0 === a[5] ? 1 : parseFloat(a[5]))
                    )),
                    n.toColor(s, r, o, i)
                  )
                if (!t || !l)
                ...
                if (
                  (t.fillRect(0, 0, 1, 1),
                  ([s, r, o, i] = t.getImageData(0, 0, 1, 1).data),
                  255 !== i)
                )
                  throw new Error('css.toColor: Unsupported css format')
                return { rgba: n.toRgba(s, r, o, i), css: e }
              }
            })(a || (t.css = a = {})),
            (function (e) {
              function t(e, t, s) {
            ...
            (function (e) {
              function t(e, t, s) {
                ...
                let n = (t >> 24) & 255,
                  ...
                  a = (t >> 8) & 255,
                  h = _(
                    c.relativeLuminance2(n, l, a),
                    c.relativeLuminance2(r, o, i)
                  )
                for (; h < s && (n > 0 || l > 0 || a > 0); )
        ...
        485: (e, t) => {
          ...
          ;(t.TwoKeyMap = s),
            (t.FourKeyMap = class {
              ...
              set(e, t, r, o, i) {
                this._data.get(e, t) || this._data.set(e, t, new s()),
                  this._data.get(e, t).set(r, o, i)
              }
              get(e, t, s, r) {
          ...
          ;(t.serviceRegistry = new Map()),
            ...
            (t.createDecorator = function (e) {
              ...
              const o = function (e, t, i) {
                ...
                !(function (e, t, o) {
                  t[s] === t
                    ? t[r].push({ id: e, index: o })
                    : ((t[r] = [{ id: e, index: o }]), (t[s] = t))
                })(o, e, i)
              }
    ...
    return (
      (() => {
            ...
            for (let t = i; t <= n; t++) {
              ...
              if (i) {
                ...
                for (let e = n; e < c; e++) {
                  ...
                  n
                    ? (this._nextCell(n, o, t, e), (o = n))
                    : console.warn(`Can't get cell at row=${t}, col=${e}`)
                }
              }
              this._rowEnd(t, t === n)
            }
        ...
        function n(e, t) {
          return (
            e.getFgColorMode() === t.getFgColorMode() &&
            e.getFgColor() === t.getFgColor()
          )
        }
        function l(e, t) {
          return (
            e.getBgColorMode() === t.getBgColorMode() &&
            e.getBgColor() === t.getBgColor()
          )
        }
        function a(e, t) {
          return (
            e.isInverse() === t.isInverse() &&
            e.isBold() === t.isBold() &&
            e.isUnderline() === t.isUnderline() &&
            e.isOverline() === t.isOverline() &&
            e.isBlink() === t.isBlink() &&
            e.isInvisible() === t.isInvisible() &&
            e.isItalic() === t.isItalic() &&
            e.isDim() === t.isDim() &&
            e.isStrikethrough() === t.isStrikethrough()
          )
        }
        class c extends i {
          constructor(e, t) {
          ...
          _beforeSerialize(e, t, s) {
            ;(this._allRows = new Array(e)),
              (this._lastContentCursorRow = t),
              (this._lastCursorRow = t),
              (this._firstRow = t)
          }
          _rowEnd(e, t) {
            this._nullCellCount > 0 &&
              !l(this._cursorStyle, this._backgroundCell) &&
              (this._currentRow += `[${this._nullCellCount}X`)
            let s = ''
            if (!t) {
              e - this._firstRow >= this._terminal.rows &&
                this._buffer
              ...
              if (r.isWrapped) {
                ...
                ;(n.getChars() && a
                  ...
                  : this._nullCellCount <= 0) &&
                  ((o.getChars() || 0 === o.getWidth()) && l(o, n) && (c = !0),
                  a &&
                    (i.getChars() || 0 === i.getWidth()) &&
                    l(o, n) &&
                    l(i, n) &&
                    (c = !0)),
                  c ||
                    ((s = '-'.repeat(this._nullCellCount + 1)),
                    (s += '[1D[1X'),
                    this._nullCellCount > 0 &&
                      ((s += '[A'),
                      (s += `[${t.length - this._nullCellCount}C`),
                      (s += `[${this._nullCellCount}X`),
                      (s += `[${t.length - this._nullCellCount}D`),
                      (s += '[B')),
                    (this._lastContentCursorRow = e + 1),
                    (this._lastContentCursorCol = 0),
                    (this._lastCursorRow = e + 1),
                    (this._lastCursorCol = 0))
              } else
                (s = '\r\n'),
                  (this._lastCursorRow = e + 1),
            ...
            ;(this._allRows[this._rowIndex] = this._currentRow),
              (this._allRowSeparators[this._rowIndex++] = s),
              (this._currentRow = ''),
              (this._nullCellCount = 0)
          }
          _diffStyle(e, t) {
            const s = [],
              ...
              i = !a(e, t)
            if (r || o || i)
              if (e.isAttributeDefault()) t.isAttributeDefault() || s.push(0)
              else {
                if (r) {
                  const t = e.getFgColor()
                  e.isFgRGB()
                    ? s.push(38, 2, (t >>> 16) & 255, (t >>> 8) & 255, 255 & t)
                    : e.isFgPalette()
                      ? t >= 16
                        ? s.push(38, 5, t)
                        : s.push(8 & t ? 90 + (7 & t) : 30 + (7 & t))
                      : s.push(39)
                }
                if (o) {
                  const t = e.getBgColor()
                  e.isBgRGB()
                    ? s.push(48, 2, (t >>> 16) & 255, (t >>> 8) & 255, 255 & t)
                    : e.isBgPalette()
                      ? t >= 16
                        ? s.push(48, 5, t)
                        : s.push(8 & t ? 100 + (7 & t) : 40 + (7 & t))
                      : s.push(49)
                }
                i &&
                  (e.isInverse() !== t.isInverse() &&
                    s.push(e.isInverse() ? 7 : 27),
                  e.isBold() !== t.isBold() && s.push(e.isBold() ? 1 : 22),
                  e.isUnderline() !== t.isUnderline() &&
                    s.push(e.isUnderline() ? 4 : 24),
                  e.isOverline() !== t.isOverline() &&
                    s.push(e.isOverline() ? 53 : 55),
                  e.isBlink() !== t.isBlink() && s.push(e.isBlink() ? 5 : 25),
                  e.isInvisible() !== t.isInvisible() &&
                    s.push(e.isInvisible() ? 8 : 28),
                  e.isItalic() !== t.isItalic() &&
                    s.push(e.isItalic() ? 3 : 23),
                  e.isDim() !== t.isDim() && s.push(e.isDim() ? 2 : 22),
                  e.isStrikethrough() !== t.isStrikethrough() &&
                    s.push(e.isStrikethrough() ? 9 : 29))
              }
            return s
          }
          _nextCell(e, t, s, r) {
            ...
            if (o ? !l(this._cursorStyle, e) : i.length > 0) {
              this._nullCellCount > 0 &&
                ...
                (this._nullCellCount = 0)),
                (this._lastContentCursorRow = this._lastCursorRow = s),
                (this._lastContentCursorCol = this._lastCursorCol = r),
                (this._currentRow += `[${i.join(';')}m`)
              const e = this._buffer.getLine(s)
              void 0 !== e &&
                (e.getCell(r, this._cursorStyle),
                (this._cursorStyleRow = s),
                (this._cursorStyleCol = r))
            }
            o
              ? (this._nullCellCount += e.getWidth())
              : (this._nullCellCount > 0 &&
                  (l(this._cursorStyle, this._backgroundCell) ||
                    (this._currentRow += `[${this._nullCellCount}X`),
                  (this._currentRow += `[${this._nullCellCount}C`),
                  (this._nullCellCount = 0)),
                (this._currentRow += e.getChars()),
                (this._lastContentCursorRow = this._lastCursorRow = s),
          ...
          _serializeString(e) {
            ...
            this._buffer.length - this._firstRow <= this._terminal.rows &&
              ((t = this._lastContentCursorRow + 1 - this._firstRow),
              (this._lastCursorCol = this._lastContentCursorCol),
              (this._lastCursorRow = this._lastContentCursorRow))
            let s = ''
            for (let e = 0; e < t; e++)
              (s += this._allRows[e]),
                e + 1 < t && (s += this._allRowSeparators[e])
            if (!e) {
              ...
              ;(e !== this._lastCursorRow || t !== this._lastCursorCol) &&
                ((r = e - this._lastCursorRow) > 0
                  ? (s += `[${r}B`)
                  : r < 0 && (s += `[${-r}A`),
                o(t - this._lastCursorCol))
            }
            var r
        ...
        e.SerializeAddon = class {
          ...
          _serializeBufferAsHTML(e, t) {
            ...
            return void 0 !== i
              ? r.serialize({
                  start: { x: i.start.x, y: i.start.y },
                  end: { x: i.end.x, y: i.end.y }
                })
              : ''
          }
          _serializeModes(e) {
            ...
            const s = e.modes
            if (
              (s.applicationCursorKeysMode && (t += '[?1h'),
              s.applicationKeypadMode && (t += '[?66h'),
              s.bracketedPasteMode && (t += '[?2004h'),
              s.insertMode && (t += '[4h'),
              s.originMode && (t += '[?6h'),
              s.reverseWraparoundMode && (t += '[?45h'),
              s.sendFocusMode && (t += '[?1004h'),
              !1 === s.wraparoundMode && (t += '[?7l'),
              'none' !== s.mouseTrackingMode)
            )
              switch (s.mouseTrackingMode) {
                case 'x10':
                  t += '[?9h'
                  break
                case 'vt200':
          ...
          serialize(e) {
            ...
            return (
              e?.excludeAltBuffer ||
                'alternate' !== this._terminal.buffer.active.type ||
                (t += `[?1049h[H${this._serializeBufferByScrollback(this._terminal, this._terminal.buffer.alternate, void 0)}`),
              e?.excludeModes || (t += this._serializeModes(this._terminal)),
              t
            )
          }
          serializeAsHTML(e) {
        ...
        class h extends i {
          constructor(e, s, r) {
            super(e),
              ...
              (this._currentRow = ''),
              (this._htmlContent = ''),
              s._core._themeService
                ? (this._ansiColors = s._core._themeService.colors.ansi)
                : (this._ansiColors = t.DEFAULT_ANSI_COLORS)
          }
          _padStart(e, t, s) {
            return (
              (t >>= 0),
              ...
              e.length > t
                ? e
                : ((t -= e.length) > s.length && (s += s.repeat(t / s.length)),
                  s.slice(0, t) + e)
            )
          }
          _beforeSerialize(e, t, s) {
            ...
            let r = '#000000',
              o = '#ffffff'
            this._options.includeGlobalBackground &&
              ((r = this._terminal.options.theme?.foreground ?? '#ffffff'),
              (o = this._terminal.options.theme?.background ?? '#000000'))
            const i = []
            i.push('color: ' + r + ';'),
              i.push('background-color: ' + o + ';'),
              i.push('font-family: ' + this._terminal.options.fontFamily + ';'),
              i.push('font-size: ' + this._terminal.options.fontSize + 'px;'),
              (this._htmlContent += "<div style='" + i.join(' ') + "'>")
          }
          _afterSerialize() {
            ;(this._htmlContent += '</div>'),
              (this._htmlContent +=
                '</pre>\x3c!--EndFragment--\x3e</body></html>')
          }
          _rowEnd(e, t) {
            ;(this._htmlContent +=
              '<div><span>' + this._currentRow + '</span></div>'),
              (this._currentRow = '')
          }
          _getHexColor(e, t) {
            const s = t ? e.getFgColor() : e.getBgColor()
            return (t ? e.isFgRGB() : e.isBgRGB())
              ? '#' +
                  [(s >> 16) & 255, (s >> 8) & 255, 255 & s]
                    .map((e) => this._padStart(e.toString(16), 2, '0'))
                    .join('')
              : (t ? e.isFgPalette() : e.isBgPalette())
                ? this._ansiColors[s].css
                : void 0
          }
          _diffStyle(e, t) {
            const s = [],
              ...
              i = !a(e, t)
            if (r || o || i) {
              const t = this._getHexColor(e, !0)
              t && s.push('color: ' + t + ';')
              const r = this._getHexColor(e, !1)
              return (
                r && s.push('background-color: ' + r + ';'),
                e.isInverse() &&
                  s.push('color: #000000; background-color: #BFBFBF;'),
                e.isBold() && s.push('font-weight: bold;'),
                e.isUnderline() && e.isOverline()
                  ? s.push('text-decoration: overline underline;')
                  : e.isUnderline()
                    ? s.push('text-decoration: underline;')
                    : e.isOverline() && s.push('text-decoration: overline;'),
                e.isBlink() && s.push('text-decoration: blink;'),
                e.isInvisible() && s.push('visibility: hidden;'),
                e.isItalic() && s.push('font-style: italic;'),
                e.isDim() && s.push('opacity: 0.5;'),
                e.isStrikethrough() && s.push('text-decoration: line-through;'),
                s
              )
            }
          }
          _nextCell(e, t, s, r) {
            ...
            i &&
              (this._currentRow +=
                0 === i.length
                  ? '</span><span>'
                  : "</span><span style='" + i.join(' ') + "'>"),
              (this._currentRow += o ? ' ' : e.getChars())
          }
          _serializeString() {
