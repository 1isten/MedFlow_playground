  ...
  (() => {
    ...
    e.r(t),
      e.d(t, {
        ...
        decodeMulti: () => O,
        decodeMultiStream: () => H,
        decodeTimestampExtension: () => g,
        decodeTimestampToTimeSpec: () => w,
        encode: () => B,
        encodeDateToTimeSpec: () => p,
        encodeTimeSpecToTimestamp: () => l,
        encodeTimestampExtension: () => y
      })
    ...
    function s(e, t, i) {
      ...
      for (; s < r; ) {
        ...
        n.length >= 4096 && ((o += String.fromCharCode(...n)), (n.length = 0))
      }
    ...
    const h = 4294967295
    function a(e, t, i) {
      const s = Math.floor(i / 4294967296),
        r = i
      e.setUint32(t, s), e.setUint32(t + 4, r)
    }
    function c(e, t) {
    ...
    function l({ sec: e, nsec: t }) {
      if (e >= 0 && t >= 0 && e <= u) {
        ...
        {
          const i = e / 4294967296,
            s = 4294967295 & e,
            r = new Uint8Array(8),
            n = new DataView(r.buffer)
          return n.setUint32(0, (t << 2) | (3 & i)), n.setUint32(4, s), r
        }
      }
      {
        const i = new Uint8Array(12),
          s = new DataView(i.buffer)
        return s.setUint32(0, t), a(s, 4, e), i
      }
    }
    function p(e) {
      const t = e.getTime(),
        ...
        s = 1e6 * (t - 1e3 * i),
        r = Math.floor(s / 1e9)
      return { sec: i + r, nsec: s - 1e9 * r }
    }
    function y(e) {
      return e instanceof Date ? l(p(e)) : null
    }
    function w(e) {
      ...
      switch (e.byteLength) {
        ...
        case 8: {
          ...
          return { sec: 4294967296 * (3 & e) + t.getUint32(4), nsec: e >>> 2 }
        }
        case 12:
          return { sec: c(t, 4), nsec: t.getUint32(0) }
        default:
          throw new o(
    ...
    const U = { type: d, encode: y, decode: g }
    class m {
      constructor() {
      ...
      register({ type: e, encode: t, decode: i }) {
        if (e >= 0) (this.encoders[e] = t), (this.decoders[e] = i)
        else {
          const s = -1 - e
    ...
    var S = function (e, t, i) {
      ...
      x = (function (e) {
        return function (t) {
          function i(i) {
            ;(t.error = t.hasError
              ? new e(i, t.error, 'An error was suppressed during disposal.')
              : i),
              (t.hasError = !0)
          }
          var s,
          ...
          return (function e() {
            for (; (s = t.stack.pop()); )
              try {
                if (!s.async && 1 === r)
                  return (r = 0), t.stack.push(s), Promise.resolve().then(e)
                if (s.dispose) {
                  var n = s.dispose.call(s.value)
                  if (s.async)
                    return (
                      (r |= 2),
                      Promise.resolve(n).then(e, function (t) {
                        return i(t), e()
                      })
                    )
                } else r |= 1
    ...
    class E {
      constructor(e) {
        ;(this.entered = !1),
          (this.extensionCodec = e?.extensionCodec ?? m.defaultCodec),
      ...
      encodeSharedRef(e) {
        ...
        try {
          return this.entered
            ? this.clone().encodeSharedRef(e)
            : (S(t, this.enteringGuard(), !1),
      ...
      encodeArray(e, t) {
        ...
        for (const i of e) this.doEncode(i, t + 1)
      }
      countWithoutUndefined(e, t) {
        let i = 0
        for (const s of t) void 0 !== e[s] && i++
        return i
      }
      encodeMap(e, t) {
        const i = Object.keys(e)
        this.sortKeys && i.sort()
        const s = this.ignoreUndefined
        ...
        for (const s of i) {
          ...
          ;(this.ignoreUndefined && void 0 === i) ||
            (this.encodeString(s), this.doEncode(i, t + 1))
        }
      }
      encodeExtension(e) {
    ...
    function B(e, t) {
      return new E(t).encodeSharedRef(e)
    }
    function v(e) {
    ...
    const A = 'array',
      ...
      z = (e) => {
        ...
        throw new o('The type of key must be string or number but ' + typeof e)
      }
    class M {
      constructor() {
      ...
      pushMapState(e) {
        const t = this.getUninitializedStateFromPool()
        ;(t.type = T), (t.readCount = 0), (t.size = e), (t.map = {})
      }
    ...
    const D = new DataView(new ArrayBuffer(0)),
    ...
    const F = new RangeError('Insufficient data'),
      C = new (class {
        ...
        find(e, t, i) {
          ...
          e: for (const r of s) {
            const s = r.bytes
            for (let r = 0; r < i; r++) if (s[r] !== e[t + r]) continue e
            return r.str
          }
          return null
        }
    ...
    class j {
      constructor(e) {
        ;(this.totalPos = 0),
          ...
          (this.maxStrLength = e?.maxStrLength ?? h),
          (this.maxBinLength = e?.maxBinLength ?? h),
          (this.maxArrayLength = e?.maxArrayLength ?? h),
          (this.maxMapLength = e?.maxMapLength ?? h),
          (this.maxExtLength = e?.maxExtLength ?? h),
          (this.keyDecoder = void 0 !== e?.keyDecoder ? e.keyDecoder : C),
          (this.mapKeyConverter = e?.mapKeyConverter ?? z)
      }
      clone() {
        return new j({
          extensionCodec: this.extensionCodec,
      ...
      createExtraByteError(e) {
        ...
        return new RangeError(
          `Extra ${t.byteLength - i} of ${t.byteLength} byte(s) found at buffer[${e}]`
        )
      }
      enteringGuard() {
        return (
      ...
      *decodeMulti(e) {
        ...
        try {
          if (this.entered) {
            const t = this.clone()
            return void (yield* t.decodeMulti(e))
          }
          for (
            I(t, this.enteringGuard(), !1),
              this.reinitializeState(),
      ...
      async decodeAsync(e) {
        ...
        try {
          ...
          const { headByte: r, pos: n, totalPos: o } = this
          throw new RangeError(
            `Insufficient data in parsing ${v(r)} at ${o} (${n} in the current buffer)`
          )
        } catch (e) {
          ;(t.error = e), (t.hasError = !0)
        } finally {
      ...
      async *decodeMultiAsync(e, t) {
        ...
        try {
          if (this.entered) {
            const i = this.clone()
            return void (yield* i.decodeMultiAsync(e, t))
          }
          I(i, this.enteringGuard(), !1)
          let s = t,
            r = -1
      ...
      doDecodeSync() {
        e: for (;;) {
          ...
          if (e >= 224) t = e - 256
            ...
            if (201 !== e) throw new o(`Unrecognized type byte: ${v(e)}`)
            {
              const e = this.lookU32()
          ...
          for (; i.length > 0; ) {
            ...
            if (e.type === A) {
              if (
                ((e.array[e.position] = t), e.position++, e.position !== e.size)
              )
                continue e
              ;(t = e.array), i.release(e)
            } else {
              if (e.type === T) {
                if ('__proto__' === t)
                  throw new o('The key __proto__ is not allowed')
                ;(e.key = this.mapKeyConverter(t)), (e.type = L)
                continue e
              }
              if (((e.map[e.key] = t), e.readCount++, e.readCount !== e.size)) {
                ;(e.key = null), (e.type = T)
                continue e
              }
              ;(t = e.map), i.release(e)
      ...
      readArraySize() {
        ...
        switch (e) {
          ...
          default:
            ...
            throw new o(`Unrecognized array type byte: ${v(e)}`)
        }
      }
      pushMapState(e) {
      ...
      stateIsMapKey() {
        return this.stack.length > 0 && this.stack.top().type === T
      }
      decodeBinary(e, t) {
      ...
      readU64() {
        const e =
          ((t = this.view),
          (i = this.pos),
          4294967296 * t.getUint32(i) + t.getUint32(i + 4))
        var t, i
        return (this.pos += 8), e
      }
      readI64() {
    ...
    async function W(e, t) {
      const i = R(e)
      return new j(t).decodeAsync(i)
    }
    function K(e, t) {
      const i = R(e)
      return new j(t).decodeArrayStream(i)
    }
    function H(e, t) {
      const i = R(e)
      return new j(t).decodeStream(i)
    }
    return t
  })()
)
